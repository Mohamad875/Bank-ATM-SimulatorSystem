<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index5.aspx.cs" Inherits="BankSystem.Index5" %>
...
<div class="content">
    <div class="deposit-container">
        <h1 class="deposit-title">Para Yatırma</h1>
        <p class="deposit-instruction">Lütfen yatırmak istediğiniz tutarı giriniz:</p>
        
        <form class="deposit-form" runat="server">
            <label for="AmountTextBox" class="amount-label">Tutar (₺):</label>
            <asp:TextBox ID="AmountTextBox" runat="server" CssClass="amount-input" Placeholder="Örneğin: 500" Min="10" Required="true"></asp:TextBox>
            
            <p class="min-limit">Minimum yatırma tutarı: 10₺</p>
            <asp:Button ID="DepositButton" runat="server" Text="Yatır" CssClass="confirm-button" OnClick="DepositButton_Click" />
