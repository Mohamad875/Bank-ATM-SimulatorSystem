<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index7.aspx.cs" Inherits="BankSystem.Index7" %>
...
<div class="content">
    <div class="bill-payment-container">
        <h1 class="bill-payment-title">Fatura Ödeme</h1>
        <p class="bill-payment-instruction">Lütfen aşağıdaki bilgileri doldurun:</p>
        
        <form class="bill-payment-form" runat="server">
            <label for="BillTypeDropDown" class="form-label">Fatura Türü:</label>
            <asp:DropDownList ID="BillTypeDropDown" runat="server" CssClass="form-input" required>
                <asp:ListItem Value="" Text="Fatura türünü seçin" Disabled="True" Selected="True"></asp:ListItem>
                <asp:ListItem Value="electricity" Text="Elektrik"></asp:ListItem>
                <asp:ListItem Value="water" Text="Su"></asp:ListItem>
                <asp:ListItem Value="internet" Text="İnternet"></asp:ListItem>
                <asp:ListItem Value="gas" Text="Doğalgaz"></asp:ListItem>
                <asp:ListItem Value="phone" Text="Telefon"></asp:ListItem>
            </asp:DropDownList>
            
            <label for="BillNumberTextBox" class="form-label">Fatura Numarası:</label>
            <asp:TextBox ID="BillNumberTextBox" runat="server" CssClass="form-input" Placeholder="Örneğin: 123456789" Required="true"></asp:TextBox>
            
            <label for="AmountTextBox" class="form-label">Tutar (₺):</label>
            <asp:TextBox ID="AmountTextBox" runat="server" CssClass="form-input" Placeholder="Örneğin: 200" Min="1" Required="true" TextMode="Number"></asp:TextBox>
            
            <p class="bill-payment-info">Fatura ödeme işlemi için ek ücret alınmaz.</p>
            <asp:Button ID="PayButton" runat="server" Text="Öde" CssClass="confirm-button" OnClick="PayButton_Click" />
            
            <asp:Label ID="MessageLabel" runat="server" ForeColor="Red" CssClass="message-label"></asp:Label>
        </form>
    </div>
</div>
