<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index3.aspx.cs" Inherits="BankSystem.Index3" %>
...
<div class="content">
    ...
    <div class="button-container">
        <div class="buttons-left">
            <a href="Index4.aspx" class="custom-button custombutton1">Para Çekme</a>
            <a href="Index5.aspx" class="custom-button custombutton2">Para Yatırma</a>
            <a href="Index6.aspx" class="custom-button custombutton3">Para Transfer</a>
        </div>
        <div class="buttons-right">
            <a href="Index7.aspx" class="custom-button custombutton4">Fatura Ödeme</a>
            <a href="Index8.aspx" class="custom-button custombutton5">Burç ve Vergiler Ödeme</a>
            <a href="Index9.aspx" class="custom-button custombutton6">Yatırım ve Borsa İşlemleri</a>
        </div>
    </div>
