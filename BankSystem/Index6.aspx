<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index6.aspx.cs" Inherits="BankSystem.Index6" %>
...
<div class="content">
    <div class="transfer-container">
        <h1 class="transfer-title">Para Transferi</h1>
        <p class="transfer-instruction">Lütfen aşağıdaki bilgileri doldurun:</p>
        
        <form class="transfer-form" runat="server">
            <label for="RecipientTextBox" class="form-label">Alıcı Hesap Numarası:</label>
            <asp:TextBox ID="RecipientTextBox" runat="server" CssClass="form-input" Placeholder="Örneğin: TR123456789" Required="true"></asp:TextBox>
            
            <label for="AmountTextBox" class="form-label">Tutar (₺):</label>
            <asp:TextBox ID="AmountTextBox" runat="server" CssClass="form-input" Placeholder="Örneğin: 500" Min="1" Required="true" TextMode="Number"></asp:TextBox>
            
            <label for="MessageTextBox" class="form-label">Mesaj (Opsiyonel):</label>
            <asp:TextBox ID="MessageTextBox" runat="server" CssClass="form-textarea" TextMode="MultiLine" Placeholder="İsteğe bağlı mesajınızı yazın..."></asp:TextBox>
            
            <p class="transfer-info">Transfer işlemi için ek ücret uygulanmaz.</p>
            <asp:Button ID="TransferButton" runat="server" Text="Gönder" CssClass="confirm-button" OnClick="TransferButton_Click" />
