<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index8.aspx.cs" Inherits="BankSystem.Index8" %>
...
<head runat="server">
    ...
    <title>Ufuk Bank - Vergi Ödeme</title>
...
<div class="content">
    <div class="bill-payment-container">
        <h1 class="bill-payment-title">Vergi Ödeme</h1>
        <p class="bill-payment-instruction">Aşağıdaki vergi bilgilerini doldurunuz:</p>
        
        <form class="bill-payment-form" runat="server">
            <label for="TaxTypeDropDown" class="form-label">Vergi Türü:</label>
            <asp:DropDownList ID="TaxTypeDropDown" runat="server" CssClass="form-input" >
                <asp:ListItem Value="" Text="Vergi türünü seçin" Disabled="True" Selected="True"></asp:ListItem>
                <asp:ListItem Value="income" Text="Gelir Vergisi"></asp:ListItem>
                <asp:ListItem Value="property" Text="Emlak Vergisi"></asp:ListItem>
                <asp:ListItem Value="traffic" Text="Trafik Cezası"></asp:ListItem>
                <asp:ListItem Value="stamp" Text="Damga Vergisi"></asp:ListItem>
            </asp:DropDownList>

            <label for="TaxNumberTextBox" class="form-label">Vergi Numarası:</label>
            <asp:TextBox ID="TaxNumberTextBox" runat="server" CssClass="form-input" Placeholder="Örn: 987654321" Required="true"></asp:TextBox>

            <label for="AmountTextBox" class="form-label">Tutar (₺):</label>
            <asp:TextBox ID="AmountTextBox" runat="server" CssClass="form-input" Placeholder="Örn: 750" Min="1" Required="true" TextMode="Number"></asp:TextBox>

            <p class="bill-payment-info">Vergi ödeme işlemi güvenli ve anlıktır.</p>
            <asp:Button ID="PayButton" runat="server" Text="Öde" CssClass="confirm-button" OnClick="PayTaxButton_Click" />
