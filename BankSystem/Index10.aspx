<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index10.aspx.cs" Inherits="BankSystem.Index10" %>
...
<div class="content">
    <div class="form-container">
        ...
        <form id="signupForm" runat="server">
            <asp:TextBox ID="NameTextBox" runat="server" CssClass="form-control" Placeholder="Full Name"></asp:TextBox>
            <br />
            <asp:TextBox ID="EmailTextBox" runat="server" CssClass="form-control" TextMode="Email" Placeholder="Email"></asp:TextBox>
            <br />
            <asp:TextBox ID="IBANTextBox" runat="server" CssClass="form-control" Placeholder="IBAN"></asp:TextBox>
            <br />
            <asp:TextBox ID="PasswordTextBox" runat="server" CssClass="form-control" TextMode="Password" Placeholder="Password"></asp:TextBox>
            <br />
            <asp:TextBox ID="PhoneTextBox" runat="server" CssClass="form-control" Placeholder="Phone Number"></asp:TextBox>
            <br />
...
<script>
  document.getElementById('signUpButton').addEventListener('click', function (event) {
      ...
      if (fullName && iban && password && password === confirmPassword) {
